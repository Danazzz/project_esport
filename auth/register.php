  ...
  <div class="card">
    <div class="card-body register-card-body">
      ...
      <form action="proses.php" method="post">
        ...
        <div class="input-group mb-3">
          <input type="tel" id="phone" name="phone" class="form-control" placeholder="Phone Number" pattern="[0-9]{13}">
          <div class="input-group-append">
            <div class="input-group-text">
        ...
        <div class="input-group mb-3">
          <input type="date" id="birth" name="birth" class="form-control" placeholder="Date of Birth">
          <!-- <div class="input-group-append">
            <div class="input-group-text">
        ...
        <div class="input-group mb-3">
          ...
          <label class="radio-inline">
            <input type="radio" name="gender" id="L" value="L" required="">Female
          </label>
          <div class="input-group-append">
          </div>
        </div>
