      ...
      <div class="card-body register-card-body">
        ...
        if (isset($_POST['register'])) {
          ...
          if ($_POST['password'] == $_POST['pw1']) {
            ...
            mysqli_query($con, "INSERT INTO auth (id_user, username, email, password) VALUES ('$id_user', '$username', '$email', '$password')") or die(mysqli_error($con));
        ...
        <a href="login.php" class="text-center">Back</a>
      </div>
      <!-- /.form-box -->
    </div><!-- /.card -->
  </div>
